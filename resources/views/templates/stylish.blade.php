<div style="font-family: 'Arial', sans-serif; margin: 0; padding: 0; display: flex; background-color: #f7f7f7;">
    <div style="background-color: #2c3e50; color: white; padding: 20px; width: 300px; box-shadow: 2px 0 10px rgba(0,0,0,0.1);">
        <div style="text-align: center;">
            <img src="{{ $resume_data['personalInformation']['cv_profile_image']??'http://localhost:3001/_next/static/media/default-user.f478f928.jpg' }}" alt="Profile Picture" style="width: 150px; height: 150px; border-radius: 50%; margin-bottom: 20px; border: 5px solid white;">
    ...
    <div style="padding: 40px; flex-grow: 1; background-color: #ffffff; box-shadow: -2px 0 10px rgba(0,0,0,0.1);">
        <div style="margin-bottom: 30px;">
            <h2 style="font-size: 22px; color: #2c3e50; margin-bottom: 15px;">Summary</h2>
            <p style="margin: 5px 0;">{{ $resume_data['personalInformation']['summary'] }}</p>
        </div>

        <div style="margin-bottom: 30px;">
            <h2 style="font-size: 22px; color: #2c3e50; margin-bottom: 15px;">Education</h2>
            <ul style="list-style-type: none; padding: 0;">
        ...
        <div style="margin-bottom: 30px;">
            <h2 style="font-size: 22px; color: #2c3e50; margin-bottom: 15px;">Experience</h2>
            <ul style="list-style-type: none; padding: 0;">
        ...
        <div>
            <h2 style="font-size: 22px; color: #2c3e50; margin-bottom: 15px;">Skills</h2>
            <ul style="list-style-type: none; padding: 0;">
