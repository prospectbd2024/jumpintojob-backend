...
namespace Illuminate\Support\Facades {
     ...
     */        class Artisan {
         ...
         *
         * @internal 
         * @return \App\Http\Controllers\Console\Kernel 
         * @static 
         */        public static function rerouteSymfonyCommandEvents()
        {            //Method inherited from \Illuminate\Foundation\Console\Kernel         
                        /** @var \App\Http\Controllers\Console\Kernel $instance */
...
namespace Mehedi8gb\ApiCrudify\Facades {
     ...
     */        class ApiCrudify {
        ...
        {            //Method inherited from \Illuminate\Console\Command         
                        /** @var \Mehedi8gb\ApiCrudify\ApiCrudify $instance */
         ...
         * @return \Mehedi8gb\ApiCrudify\ApiCrudify 
         * @static 
         */        public static function setHidden($hidden = true)
        {            //Method inherited from \Illuminate\Console\Command         
                        /** @var \Mehedi8gb\ApiCrudify\ApiCrudify $instance */
        ...
        {            //Method inherited from \Symfony\Component\Console\Command\Command         
                        return \Mehedi8gb\ApiCrudify\ApiCrudify::getDefaultName();
        }
                    /**
         * 
         *
        ...
        {            //Method inherited from \Symfony\Component\Console\Command\Command         
                        return \Mehedi8gb\ApiCrudify\ApiCrudify::getDefaultDescription();
        }
                    /**
        ...
        {            //Method inherited from \Symfony\Component\Console\Command\Command         
                        /** @var \Mehedi8gb\ApiCrudify\ApiCrudify $instance */
                        $instance->ignoreValidationErrors();
        }
                    /**
         * 
         *
        ...
        {            //Method inherited from \Symfony\Component\Console\Command\Command         
                        /** @var \Mehedi8gb\ApiCrudify\ApiCrudify $instance */
                        $instance->setHelperSet($helperSet);
        }
                    /**
         * Gets the helper set.
         *
         ...
         *
         * @static 
         */        public static function complete($input, $suggestions)
        {            //Method inherited from \Symfony\Component\Console\Command\Command         
                        /** @var \Mehedi8gb\ApiCrudify\ApiCrudify $instance */
                        return $instance->complete($input, $suggestions);
        }
                    /**
         ...
         *
         * @return \Symfony\Component\Console\Command\HelperInterface 
         ...
         * @return int 
         * @static 
         */        public static function callSilently($command, $arguments = [])
        {            //Method inherited from \Illuminate\Console\Command         
                        /** @var \Mehedi8gb\ApiCrudify\ApiCrudify $instance */
                        return $instance->callSilently($command, $arguments);
        }
                    /**
         ...
         *
         * @param \Illuminate\Console\iterable|int $totalSteps
         * @param \Closure $callback
         * @return mixed|void 
         * @static 
         */        public static function withProgressBar($totalSteps, $callback)
        {            //Method inherited from \Illuminate\Console\Command         
                        /** @var \Mehedi8gb\ApiCrudify\ApiCrudify $instance */
                        return $instance->withProgressBar($totalSteps, $callback);
        }
                    /**
        ...
        {            //Method inherited from \Illuminate\Console\Command         
                        /** @var \Mehedi8gb\ApiCrudify\ApiCrudify $instance */
                        $instance->alert($string, $verbosity);
        }
                    /**
         * Write a blank line.
         *
         ...
         * @static 
         */        public static function outputComponents()
        {            //Method inherited from \Illuminate\Console\Command         
                        /** @var \Mehedi8gb\ApiCrudify\ApiCrudify $instance */
                        return $instance->outputComponents();
        }
                    /**
         * Define a callback to be run when the given signal(s) occurs.
         *
         * @template TSignals of iterable<array-key, int>|int
         * @param \Illuminate\Console\(\Closure():(TSignals))|\Illuminate\Console\TSignals $signals
         * @param \Illuminate\Console\callable(int $signal): void  $callback
         * @return void 
         * @static 
         */        public static function trap($signals, $callback)
        {            //Method inherited from \Illuminate\Console\Command         
                        /** @var \Mehedi8gb\ApiCrudify\ApiCrudify $instance */
                        $instance->trap($signals, $callback);
        }
                    /**
         ...
         */        public static function macro($name, $macro)
        {            //Method inherited from \Illuminate\Console\Command         
                        \Mehedi8gb\ApiCrudify\ApiCrudify::macro($name, $macro);
        }
                    /**
         * Mix another object into the class.
         *
         ...
         */        public static function mixin($mixin, $replace = true)
        {            //Method inherited from \Illuminate\Console\Command         
                        \Mehedi8gb\ApiCrudify\ApiCrudify::mixin($mixin, $replace);
        }
                    /**
         * Checks if macro is registered.
         *
         ...
         */        public static function hasMacro($name)
        {            //Method inherited from \Illuminate\Console\Command         
                        return \Mehedi8gb\ApiCrudify\ApiCrudify::hasMacro($name);
        }
                    /**
         * Flush the existing macros.
         *
         ...
         */        public static function flushMacros()
        {            //Method inherited from \Illuminate\Console\Command         
                        \Mehedi8gb\ApiCrudify\ApiCrudify::flushMacros();
        }
            }
    }
...
namespace  {
            ...
            class ApiCrudify extends \Mehedi8gb\ApiCrudify\Facades\ApiCrudify {}
